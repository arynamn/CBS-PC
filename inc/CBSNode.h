...
{
public:
	// The following is used to compare nodes in the OPEN list by f_val (top of the heap has min f_val)
	struct compare_node
	{
	...
	// The following is used to compare nodes in the FOCAL list by tie_breaking value (top of the heap has min tie_breaking value)
	...
	// The following is used by  for generating the hash value of a nodes this is needed because otherwise we'll have to define the specialized template inside std namespace
